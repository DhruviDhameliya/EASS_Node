...
const cron6 = require("node-cron");
const cron7 = require("node-cron");
const cron8 = require("node-cron");
const cron9 = require("node-cron");
const cron10 = require("node-cron");
...
var task8 = cron8.schedule(`54 09 * * *`, async () => {
  await adminapi.sendmailofprocesslimittousers();
});
task8.start();


var task3 = cron3.schedule(`45 07 * * *`, async () => {
  await adminapi.sendEnquiryCronMail();
});
task3.start();

var task7 = cron7.schedule(`00 08 * * *`, async () => {
  await adminapi.sendMailOfProcessLimitDate();
});
task7.start();


var task = cron1.schedule(`15 08 * * *`, async () => {
  await adminapi.sendMailofApplicationStatus();
});
task.start();

var task4 = cron4.schedule(`30 08 * * *`, async () => {
  await adminapi.sendReadyforDispatchCronMail();
  await adminapi.sendReadyforDispatchUserCronMail();
});
task4.start();

var task6 = cron6.schedule(`16 10 * * *`, async () => {
...
var task1 = cron.schedule(`00 09 * * *`, async () => {
...
var task5 = cron5.schedule(`15 09 * * *`, async () => {
  await adminapi.sendMailofHoldApplicationStatus();
});
task5.start();


var task9 = cron9.schedule(`30 19 * * *`, async () => {
  await adminapi.feedbackmailsend();
});
task9.start();


var task10 = cron10.schedule(`00 20 * * *`, async () => {
...
// //get-cashflowdetails
// app.get("/get-cashflowdetails/:cashflow_id", authTokenMiddleware, async function (req, res) {
...
// //Update UserData
// app.post("/updateuserdata", authTokenMiddleware, async function (req, res) {
//   if (req.files != null) {
...
// //Insert Attribute
// app.post("/insert-attribute", authTokenMiddleware, async function (req, res) {
...
// //Get AllAttributes
// app.get("/get-allattribute/:type/:page/:perpage", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-attrstatus", authTokenMiddleware, async function (req, res) {
...
// //Update Attribute
// app.post("/update-attribute", authTokenMiddleware, async function (req, res) {
...
// //Insert Branch
// app.post("/insert-branch", authTokenMiddleware, async function (req, res) {
...
// //Get AllBranch
// app.get("/get-allbranch", authTokenMiddleware, async function (req, res) {
...
// //Update Branch
// app.post("/update-branch", authTokenMiddleware, async function (req, res) {
//   let filename = "null";
...
// //Delete Branch
// app.get("/delete-branch/:id", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-typecountry/:type/:country", authTokenMiddleware, async function (req, res) {
...
// //Insert Service
// app.post("/insert-service", authTokenMiddleware, async function (req, res) {
...
// //Delete Service
// app.get("/delete-service/:id", authTokenMiddleware, async function (req, res) {
...
// //Get AllService
// app.get("/get-allservice/:page/:perpage", authTokenMiddleware, async function (req, res) {
...
// //Insert Feature
// app.post("/insert-feature", authTokenMiddleware, async function (req, res) {
...
// //Get AllFeature
// app.get("/get-allFeature", authTokenMiddleware, async function (req, res) {
...
// //Update Feature
// app.post("/update-feature", authTokenMiddleware, async function (req, res) {
...
// //Delete Feature
// app.get("/delete-feature/:id", authTokenMiddleware, async function (req, res) {
...
// //Get LandSource
// app.get("/get-leadsource", authTokenMiddleware, async function (req, res) {
...
// //Get All Lead
// app.get("/get-alllead/:id/:page/:perpage", authTokenMiddleware, async function (req, res) {
...
// //Delete Lead
// app.get("/delete-lead/:id", authTokenMiddleware, async function (req, res) {
...
// //Update Lead
// app.post("/update-lead", authTokenMiddleware, async function (req, res) {
...
// //Search Lead
// app.post("/search-lead", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-users/:bid/:uid", authTokenMiddleware, async function (req, res) {
...
// //Get All Lead Status
// app.get("/get-allleadstatus", authTokenMiddleware, async function (req, res) {
...
// //update-leadbranch
// app.post("/update-leadbranch", authTokenMiddleware, async function (req, res) {
...
// //update-leadstatus
// app.post("/update-leadstatus", authTokenMiddleware, async function (req, res) {
//   if (req.files != undefined) {
...
// //update-leadpriority
// app.post("/update-leadpriority", authTokenMiddleware, async function (req, res) {
...
// //insert-followup
// app.post("/insert-followup", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-followup", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-setting", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-setting", authTokenMiddleware, async function (req, res) {
//   let filename = "null";
//   if (req.files != undefined) {
//     const file = req.files.logo;
//     var currentdate = new Date();
...
// //insert-smstemplate
// app.post("/insert-smstemplate", authTokenMiddleware, async function (req, res) {
...
// //Get All SMSTemlate
// app.get("/get-allsmstemlate", authTokenMiddleware, async function (req, res) {
...
// //Delete SMSTemplate
// app.get("/delete-smstemplate/:id", authTokenMiddleware, async function (req, res) {
...
// //update-smstemplate
// app.post("/update-smstemplate", authTokenMiddleware, async function (req, res) {
...
// //update-allocatedto
// app.post("/update-allocatedto", authTokenMiddleware, async function (req, res) {
...
// //sakshi
// app.post("/insert-role", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-allrole", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-rolepermission/:id", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-role", authTokenMiddleware, async function (req, res) {
...
// app.post("/insert-user", authTokenMiddleware, async function (req, res) {
//   if (req.files != null) {
//     var currentdate = new Date();
//     var time = currentdate.getTime();
//     let filename = "";
...
// app.get("/get-userbyparent/:id/:branch_id", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-user", authTokenMiddleware, async function (req, res) {
//   if (req.files != null) {
//     var currentdate = new Date();
//     var time = currentdate.getTime();
//     let filename = "";
...
// app.get("/delete-user/:id", authTokenMiddleware, async function (req, res) {
...
// app.get("/getuserbytype/:id", authTokenMiddleware, async function (req, res) {
...
// app.post("/insert-managerallocation", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-allocationlist", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-branchallocationlist/:id", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-managerallocation", authTokenMiddleware, async function (req, res) {
...
// app.get("/delete-managerallocation/:id", authTokenMiddleware, async function (req, res) {
...
// app.get("/delete-allocatedbranchbyid/:id/:bid", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-template-category", authTokenMiddleware, async function (req, res) {
...
// app.post("/change-templatestatus", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-template-subcategory/:id", authTokenMiddleware, async function (req, res) {
...
// app.post("/insert-emailTemplate", authTokenMiddleware, async function (req, res) {
//   if (req.files != undefined) {
...
// app.get("/get-emailtemplate", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-emailtemplate", authTokenMiddleware, async function (req, res) {
//   let recordname = [];
//   if (req.files != undefined) {
//     const myfile = req.files.file;
//     let newpath = paths.join(
...
// app.get("/delete-emailtemplate/:id", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-branchdata/:id", authTokenMiddleware, async function (req, res) {
...
// //get attribute by id
// app.get("/get-attributebyid/:id", authTokenMiddleware, async function (req, res) {
...
// //delete email image
// app.get("/delete-emailimage/:id", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-branchsetting", authTokenMiddleware, async function (req, res) {
//   let filename = "null";
//   if (req.files != undefined) {
//     const file = req.files.logo;
//     var currentdate = new Date();
...
// //Insert Task
// app.post("/insert-task", authTokenMiddleware, async function (req, res) {
//   if (req.files != undefined) {
//     const myfile = req.files.file;
//     let newpath = paths.join(
//       __dirname,
...
// //Get task
// app.get("/get-alltask/:id/:page/:perPage", authTokenMiddleware, async function (req, res) {
...
// //delete task
// app.get("/delete-task/:id", authTokenMiddleware, async function (req, res) {
...
// //delete task image
// app.get("/delete-taskimage/:id", authTokenMiddleware, async function (req, res) {
...
// //update task
// app.post("/update-task", authTokenMiddleware, async function (req, res) {
//   let recordname = [];
//   if (req.files != undefined) {
//     const myfile = req.files.file;
//     let newpath = paths.join(
...
// //update-taskpriority
// app.post("/update-taskpriority", authTokenMiddleware, async function (req, res) {
...
// //update-taskstatus
// app.post("/update-taskstatus", authTokenMiddleware, async function (req, res) {
...
// app.get("/gettodayleadfollowup/:id", authTokenMiddleware, async function (req, res) {
...
// //update taskrevision
// app.post("/update-taskrevision", authTokenMiddleware, async function (req, res) {
//   if (req.files != undefined) {
...
// //get allfeedback
// app.get("/get-taskfeedback/:id", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-taskallocatedto", authTokenMiddleware, async function (req, res) {
...
// app.post("/insert-taskfeedback", authTokenMiddleware, async function (req, res) {
//   if (req.files != undefined) {
//     const file = req.files.file;
//     // var currentdate = new Date();
//     // var time = currentdate.getTime();
...
// //get-totaltask
// app.get("/get-totaltask/:u_id/:t_status", authTokenMiddleware, async function (req, res) {
...
// //get-totallead
// app.get("/get-totallead/:u_id/:l_service", authTokenMiddleware, async function (req, res) {
...
// //get-totaltodaylead
// app.get("/get-totaltodaylead/:u_id/:l_service", authTokenMiddleware, async function (req, res) {
...
// //insert maincustomer
// app.post("/insert-maincustomer", authTokenMiddleware, async function (req, res) {
...
// //get customer
// app.get("/get-allcustomer/:page/:perpage/:uid/:bid", authTokenMiddleware, async function (req, res) {
...
// });
// //get customer amount
// app.post("/get-customer-amount", authTokenMiddleware, async function (req, res) {
...
// //payment update
// app.post("/update-payment", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-paymentWithAdditionalCharges", authTokenMiddleware, async function (req, res) {
...
// });
// //get-payment by id
// app.get("/get-payment/:id", authTokenMiddleware, async function (req, res) {
...
// //search customer
// app.post("/search-customer", authTokenMiddleware, async function (req, res) {
...
// //get customer by id
// app.get("/get-customer/:id", authTokenMiddleware, async function (req, res) {
...
// //update customer
// app.post("/update-customer", authTokenMiddleware, async function (req, res) {
...
// //get visacustomer
// app.get("/get-visacustomer/:u_id/:branch_id/:page/:perPage", authTokenMiddleware, async function (
//   req,
//   res
// ) {
...
// //update visa status
// app.post("/update-visastatus", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-detailsstatus", authTokenMiddleware, async function (req, res) {
//   date = moment().format("DD-MM-YYYY");
...
// app.get("/delete-visacustomer/:id", authTokenMiddleware, async function (req, res) {
...
// app.post("/check-customer", authTokenMiddleware, async function (req, res) {
...
// app.get(
//   "/get-attestationcustomer/:u_id/:branch_id/:page/:perPage", authTokenMiddleware,
...
// app.get("/get-attestationcustomerbyid/:detail_id", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-visacustomer", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-attestationstatus", authTokenMiddleware, async function (req, res) {
//   let date = moment().format("DD-MM-YYYY");
...
// app.get(
//   "/delete-attestationcustomer/:id/:branch_state_id/:s_c_gst/:s_s_gst/:s_i_gst", authTokenMiddleware,
//   async function (req, res) {
//     let date = moment().format("DD-MM-YYYY");
...
// app.post("/update-attestationcustomer", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-visacustomer", authTokenMiddleware, async function (req, res) {
...
// app.post("/send-attestationmail", authTokenMiddleware, async function (req, res) {
...
// app.post("/send-apostillemail", authTokenMiddleware, async function (req, res) {
...
// app.post("/send-visamail", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-attestationcustomer", authTokenMiddleware, async function (req, res) {
...
// app.post("/insert-customerconversation", authTokenMiddleware, async function (req, res) {
//   if (req.files != undefined) {
//     const file = req.files.file;
//     var currentdate = new Date();
//     var time = currentdate.getTime();
...
// //get allcomment
// app.get("/get-customercomment/:id", authTokenMiddleware, async function (req, res) {
...
// app.post("/upload-customerfile", authTokenMiddleware, async function (req, res) {
//   let recordname = [];
//   if (req.files != undefined) {
//     const myfile = req.files.file;
...
// //Get files
// app.get("/get-allfilesbyid/:id", authTokenMiddleware, async function (req, res) {
...
// //Delete file
// app.get("/delete-file/:id", authTokenMiddleware, async function (req, res) {
...
// //get payment details
// app.get("/get-paymentdetails/:id", authTokenMiddleware, async function (req, res) {
...
// //Delete Customer
// app.get("/delete-customer/:id", authTokenMiddleware, async function (req, res) {
...
// //search payment
// app.post("/search-payment", authTokenMiddleware, async function (req, res) {
...
// });
// //update - td-status
// app.post("/update-tds", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-visacustomerbyid/:detail_id", authTokenMiddleware, async function (req, res) {
...
// //get payment details
// app.get("/get-paymentdetail/:page/:perpage/:uid/:bid", authTokenMiddleware, async function (
//   req,
//   res
// ) {
...
// app.post("/insert-refundpayment", authTokenMiddleware, async function (req, res) {
//   let date = moment().format("DD-MM-YYYY");
...
// //get payment refund
// app.get("/get-paymentrefund/:u_id/:page/:perPage", authTokenMiddleware, async function (req, res) {
//   let date = moment().format("DD-MM-YYYY");
...
// app.post("/search-refunddata", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-underprocesslist/:u_id/:branch_id/:user_type", authTokenMiddleware, async function (
//   req,
//   res
// ) {
...
// //search cashflow
// app.post("/search-cashflow", authTokenMiddleware, async function (req, res) {
...
// //get branch user
// app.get("/get-branchuser/:id", authTokenMiddleware, async function (req, res) {
...
// //get branch user
// app.get("/get-cashpayment/:u_id/:b_id", authTokenMiddleware, async function (req, res) {
...
// //insert cashflow
// app.post("/insert-cashflow", authTokenMiddleware, async function (req, res) {
...
// //Delete cashflow
// app.get("/delete-cashflow/:id", authTokenMiddleware, async function (req, res) {
...
// //search task data
// app.post("/search-taskdata", authTokenMiddleware, async function (req, res) {
...
// //Invoice Module
// app.get("/get-invoicedata/:id/:uid", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-customeraddress", authTokenMiddleware, async function (req, res) {
...
// app.get("/fetch-pdf/:id", authTokenMiddleware, async function (req, res) {
//   const data = req.params;
//   res.sendFile(`${__dirname}/public/Assets/invoice_pdf/invoice_${data.id}.pdf`);
// });

// app.post("/send-invoicemail", authTokenMiddleware, async function (req, res) {
...
// app.get("/fetch-branchdatabyid/:bid", authTokenMiddleware, async function (req, res) {
...
// app.get(
//   "/get-apostillecustomer/:u_id/:branch_id/:page/:perPage", authTokenMiddleware,
//   async function (req, res) {
...
// app.post("/update-apostillestatus", authTokenMiddleware, async function (req, res) {
//   let date = moment().format("DD-MM-YYYY");
...
// app.get("/get-apostillecustomerbyid/:detail_id", authTokenMiddleware, async function (req, res) {
...
// app.get(
//   "/delete-apostillecustomer/:id/:branch_state_id/:s_c_gst/:s_s_gst/:s_i_gst", authTokenMiddleware,
//   async function (req, res) {
//     let date = moment().format("DD-MM-YYYY");
...
// app.post("/search-excelreports", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-apostillecustomer", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-apostillecustomer", authTokenMiddleware, async function (req, res) {
...
// //get-tds
// app.post("/get-tds", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-businesssummary/:page/:perpage/:u_id/:b_id", authTokenMiddleware, async function (
//   req,
//   res
// ) {
...
// app.post("/search-businesssummary", authTokenMiddleware, async function (req, res) {
...
// //get refund by id
// app.get("/get-refundbyid/:id/:u_id", authTokenMiddleware, async function (req, res) {
...
// //get refund recipt
// app.get("/get-refundreceipt/:id/:rec_no/:u_id", authTokenMiddleware, async function (req, res) {
...
// app.get("/fetch-refundreceipt/:id", authTokenMiddleware, async function (req, res) {
//   const data = req.params;
//   res.sendFile(
...
// app.get("/get-paymentdata/:id/:branch_id/:u_id", authTokenMiddleware, async function (req, res) {
...
// //get payment receipt
// app.get("/get-paymentreceipt/:id/:rec_no/:u_id/:branch_id", authTokenMiddleware, async function (
//   req,
//   res
// ) {
...
// app.get("/fetch-paymentreceipt/:id", authTokenMiddleware, async function (req, res) {
//   const data = req.params;
//   res.sendFile(
...
// app.get("/fetch-graphleaddata/:id", authTokenMiddleware, async function (req, res) {
...
// app.post("/generate-cregistrationreport", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-attestationcover", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-visacover", authTokenMiddleware, async function (req, res) {
...
// });
// //search attestation cover later
// app.post("/search-apostillecover", authTokenMiddleware, async function (req, res) {
...
// app.post("/attestation-pdf", authTokenMiddleware, async function (req, res) {
...
// app.get("/fetch-attestation-pdf/:id", authTokenMiddleware, async function (req, res) {
//   const data = req.params;
//   res.sendFile(
...
// app.post("/apostille-pdf", authTokenMiddleware, async function (req, res) {
...
// app.post("/visa-pdf", authTokenMiddleware, async function (req, res) {
...
// app.get("/fetch-apostille-pdf/:id", authTokenMiddleware, async function (req, res) {
//   const data = req.params;
//   res.sendFile(
...
// app.get("/fetch-visa-pdf/:id", authTokenMiddleware, async function (req, res) {
//   const data = req.params;
//   res.sendFile(`${__dirname}/public/Assets/visa_pdf/visa_${data.id}.pdf`);
// });

// //Ready For Delivery Report
// app.post("/generate-rdeliveryreport", authTokenMiddleware, async function (req, res) {
...
// });
// //Ready For Delivery Report
// app.post("/generate-allrdeliveryreport", authTokenMiddleware, async function (req, res) {
...
// //Ready For Delivery Report
// app.post("/generate-rdeliveryhistoryreport", authTokenMiddleware, async function (req, res) {
...
// //Ready For Delivery Report
// app.post("/generate-allrdeliveryhistoryreport", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-dispatch", authTokenMiddleware, async function (req, res) {
...
// app.post("/dispatch-pdf", authTokenMiddleware, async function (req, res) {
...
// app.get("/fetch-dispatch-pdf/:id", authTokenMiddleware, async function (req, res) {
//   const data = req.params;
//   res.sendFile(
...
// app.post("/accountreport-pdf", authTokenMiddleware, async function (req, res) {
...
// });
// //get branch customer
// app.get("/get-branchcustomer/:branch_id/:u_id", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-accountreports", authTokenMiddleware, async function (req, res) {
...
// app.get("/fetch-accountreport-pdf/:id", authTokenMiddleware, async function (req, res) {
//   const data = req.params;
//   res.sendFile(
...
// app.post("/send-refundmail", authTokenMiddleware, async function (req, res) {
...
// app.post("/send-paymentmail", authTokenMiddleware, async function (req, res) {
...
// app.post("/lead-report", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-leadcountreport", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-adminallocatereport", authTokenMiddleware, async function (req, res) {
//   const data = await adminapi.adminAllocateReport(req.body);
//   res.send({
//     ...data,
//   });
// });
// app.post("/search-customercountreport", authTokenMiddleware, async function (req, res) {
...
// app.get("/convert-lead/:id/:u_id/:branch_id", authTokenMiddleware, async function (req, res) {
//   date = moment().format("DD-MM-YYYY");
...
// app.post("/search-leadfollowupcountreport", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-leadfollowupcounter", authTokenMiddleware, async function (req, res) {
...
// app.post("/profit-cost", authTokenMiddleware, async function (req, res) {
...
// //full copy
// app.get("/fullcopy/:c_id", authTokenMiddleware, async function (req, res) {
...
// //half copy
// app.get("/halfcopy/:c_id", authTokenMiddleware, async function (req, res) {
...
// //download-allpdf
// app.post("/download-allinvoicepdf", authTokenMiddleware, async function (req, res) {
...
// //insert leadcustomer
// app.post("/insert-leadcustomer", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-proformainvoicedata/:id/:uid", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-proformainvoice", authTokenMiddleware, async function (req, res) {
...
// app.get("/fetch-proformainvoicepdf/:id", authTokenMiddleware, async function (req, res) {
//   const data = req.params;
//   res.sendFile(
...
// app.post("/get-selectionamount", authTokenMiddleware, async function (req, res) {
...
// //Update Serviceprice
// app.post("/update-service", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-dispatchdate", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-allemailtemplate", authTokenMiddleware, async function (req, res) {
...
// //Send Lead Mail
// app.post("/send-leadmail", authTokenMiddleware, async function (req, res) {
//   if (req.files != undefined) {
//     const myfile = req.files.file;
//     let newpath = paths.join(
//       __dirname,
...
// //get Customer
// app.get("/get-customers/:m_c_id/:page/:perpage", authTokenMiddleware, async function (req, res) {
...
// //serachCustomer
// app.post("/search-customers", authTokenMiddleware, async function (req, res) {
...
// //get Attestation
// app.get("/get-attestations/:m_c_id/:page/:perpage", authTokenMiddleware, async function (req, res) {
...
// //search attestation
// app.post("/search-attestations", authTokenMiddleware, async function (req, res) {
...
// //get Apostille
// app.get("/get-apostilles/:m_c_id/:page/:perpage", authTokenMiddleware, async function (req, res) {
...
// //search apostille
// app.post("/search-apostilles", authTokenMiddleware, async function (req, res) {
...
// //get Visa
// app.get("/get-visas/:m_c_id/:page/:perpage", authTokenMiddleware, async function (req, res) {
...
// //search visa
// app.post("/search-visas", authTokenMiddleware, async function (req, res) {
...
// //get payment details
// app.get("/get-payments/:m_c_id/:page/:perpage", authTokenMiddleware, async function (req, res) {
...
// //search payment
// app.post("/search-payments", authTokenMiddleware, async function (req, res) {
...
// //get-tds
// app.get("/get-customertdslist/:m_c_id/:page/:perpage", authTokenMiddleware, async function (
//   req,
//   res
// ) {
...
// //search tds
// app.post("/search-tdsdata", authTokenMiddleware, async function (req, res) {
...
// //get Applicant
// app.get("/get-applicants/:c_id/:c_s_type", authTokenMiddleware, async function (req, res) {
...
// //Insert customer conversation
// app.post("/insert-feedback", authTokenMiddleware, async function (req, res) {
//   if (req.files != undefined) {
//     const file = req.files.file;
//     var currentdate = new Date();
//     var time = currentdate.getTime();
...
// //get allcomment
// app.get("/get-feedback/:m_c_id/:page/:perpage", authTokenMiddleware, async function (req, res) {
...
// //insert-goal
// app.post("/insert-goal", authTokenMiddleware, async function (req, res) {
...
// //Get All Goal
// app.get("/get-allgoal", authTokenMiddleware, async function (req, res) {
...
// //Update Goal
// app.post("/update-goal", authTokenMiddleware, async function (req, res) {
...
// //Delete Goal
// app.get("/delete-goal/:id", authTokenMiddleware, async function (req, res) {
...
// //get all goal list
// app.get("/get-allgoallist/:u_id", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-alldashtask/:id", authTokenMiddleware, async function (req, res) {
...
// //Get user-branch Admin-staff
// app.get("/get-taskusers/:bid/:uid", authTokenMiddleware, async function (req, res) {
...
// //transferbranch
// app.post("/transfer-branch", authTokenMiddleware, async function (req, res) {
...
// app.get("/fetch-managerbranch/:uid", authTokenMiddleware, async function (req, res) {
...
// app.get("/fetch-branchuserdata/:bid", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-revenuedata", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-activitylog/:detail_id", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-login_logout_report", authTokenMiddleware, async function (req, res) {
...
// app.get("/login_logout_report/:page/:perpage", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-allholdapplication/:u_id/:branch_id", authTokenMiddleware, async function (req, res) {
...
// app.post("/insert-nextholdcomment", authTokenMiddleware, async function (req, res) {
...
// app.get(
//   "/get-translationcustomer/:u_id/:branch_id/:page/:perPage", authTokenMiddleware,
//   async function (req, res) {
...
// app.post("/update-translationcustomer", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-translationcustomer", authTokenMiddleware, async function (req, res) {
...
// app.get(
//   "/delete-translationcustomer/:id/:branch_state_id/:s_c_gst/:s_s_gst/:s_i_gst", authTokenMiddleware,
//   async function (req, res) {
//     let date = moment().format("DD-MM-YYYY");
...
// app.get("/get-translationcustomerbyid/:detail_id", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-translationstatus", authTokenMiddleware, async function (req, res) {
//   let date = moment().format("DD-MM-YYYY");
...
// app.post("/translation-pdf", authTokenMiddleware, async function (req, res) {
...
// app.get("/fetch-translation-pdf/:id", authTokenMiddleware, async function (req, res) {
//   const data = req.params;
//   res.sendFile(
...
// app.post("/search-translationcover", authTokenMiddleware, async function (req, res) {
...
// app.post("/send-translationmail", authTokenMiddleware, async function (req, res) {
...
// //get translation
// app.get("/get-translations/:m_c_id/:page/:perpage", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-newtasknotification", authTokenMiddleware, async function (req, res) {
...
// app.get("/readtasknotification/:t_id", authTokenMiddleware, async function (req, res) {
...
// //Get task by id
// app.get("/get-taskbyid/:t_id", authTokenMiddleware, async function (req, res) {
...
// app.post("/send-leadinvoicemail", authTokenMiddleware, async function (req, res) {
...
// app.post("/send-leademail", authTokenMiddleware, async function (req, res) {
...
// //block customer
// app.post("/block-customer", authTokenMiddleware, async function (req, res) {
...
// app.post("/changecustomerpassword", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-templatelistbycate/:cid/:scid", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-templatedata/:etid", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-courierchargereport", authTokenMiddleware, async function (req, res) {
...
// app.post("/send-tempmail", authTokenMiddleware, async function (req, res) {
...
// app.post("/insertfaqcategory", authTokenMiddleware, async function (req, res) {
...
// app.get("/getfaqcategory", authTokenMiddleware, async function (req, res) {
...
// app.post("/updatefaqcategory", authTokenMiddleware, async function (req, res) {
...
// app.post("/insertfaq", authTokenMiddleware, async function (req, res) {
//   if (req.files != undefined) {
//     const myfile = req.files.file;
...
// app.get("/getfaq", authTokenMiddleware, async function (req, res) {
...
// app.post("/updatefaq", authTokenMiddleware, async function (req, res) {
//   if (req.files != undefined) {
//     const myfile = req.files.file;
//     let newpath = paths.join(__dirname, "/public/Assets/images/faq_doc/");
//     var name = myfile.name;
...
// //Delete FAQ
// app.get("/deletefaq/:id", authTokenMiddleware, async function (req, res) {
...
// app.get("/deletefaqcategory/:id", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-ProcessLimitDate/:a_type", authTokenMiddleware, async function (req, res) {
...
// app.post("/inserttarget", authTokenMiddleware, async function (req, res) {
...
// //get target of user
// app.get("/gettarget", authTokenMiddleware, async function (req, res) {
...
// app.post("/updatetarget", authTokenMiddleware, async function (req, res) {
...
// app.get("/usertargetreport/:id", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-totalinvoice", authTokenMiddleware, async function (req, res) {
...
// //approve payment
// app.post("/approved-payment", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-draftreceipt/:page/:perpage/:uid/:bid/:pmode", authTokenMiddleware, async function (
//   req,
//   res
// ) {
...
// app.get("/get-draftpaymentdata/:id/:branch_id/:u_id", authTokenMiddleware, async function (
//   req,
//   res
// ) {
...
// //get payment receipt
// app.get(
//   "/get-draftpaymentreceipt/:id/:rec_no/:u_id/:branch_id", authTokenMiddleware,
//   async function (req, res) {
...
// app.get("/fetch-draftpaymentreceipt/:id", authTokenMiddleware, async function (req, res) {
//   const data = req.params;
//   res.sendFile(
...
// app.post("/search-draftpayment", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-accountsummary", authTokenMiddleware, async function (req, res) {
...
// app.post("/send-mailfortranslation", authTokenMiddleware, async function (req, res) {
...
// //insert suggestion
// app.post("/insert-suggestion", authTokenMiddleware, async function (req, res) {
//   if (req.files != undefined) {
//     const myfile = req.files.file;
//     let newpath = paths.join(
//       __dirname,
...
// app.get("/get-suggestion/:u_id/:u_type/:branch_id", authTokenMiddleware, async function (req, res) {
...
// //update suggestion
// app.post("/update-suggestion", authTokenMiddleware, async function (req, res) {
//   if (req.files != undefined) {
//     const myfile = req.files.file;
//     let newpath = paths.join(
//       __dirname,
...
// app.get("/delete-suggestion/:sg_id", authTokenMiddleware, async function (req, res) {
...
// app.get("/usermonthtargetreport/:id", authTokenMiddleware, async function (req, res) {
...
// //Delete Suggestion by id
// app.get("/delete-usertarget/:t_id", authTokenMiddleware, async function (req, res) {
...
// //Get Main Customer
// app.get("/get-maincustomer/:id/:page/:perpage", authTokenMiddleware, async function (req, res) {
...
// app.post("/updatemaincustomerdetails", authTokenMiddleware, async function (req, res) {
...
// //Send Login Mail
// app.post("/send-loginmail", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-maincustomer", authTokenMiddleware, async function (req, res) {
...
// //Insert Embassyfees
// app.post("/insert-embassyfee", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-embassyfees/:page/:perpage", authTokenMiddleware, async function (req, res) {
...
// //Update Embassyfees
// app.post("/update-embassyfees", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-chargereport", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-embassy-amount", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-courierreport", authTokenMiddleware, async function (req, res) {
//   const data = await adminapi.getcourierreport(req.body);
//   res.send({
//     ...data,
//   });
// });
// app.post("/get-allcourierreport", authTokenMiddleware, async function (req, res) {
...
// //Get Marketing Lead
// app.get("/get-allnewlead/:id", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-allcover", authTokenMiddleware, async function (req, res) {
...
// app.post("/all-coverpdf", authTokenMiddleware, async function (req, res) {
...
// app.get("/fetch-allcover-pdf", authTokenMiddleware, async function (req, res) {
//   res.sendFile(`${__dirname}/public/Assets/allcover.pdf`);
// });

// app.post("/search-statuswiseleadreport", authTokenMiddleware, async function (req, res) {
...
// //Collected Report
// app.post("/generate-collectedreport", authTokenMiddleware, async function (req, res) {
...
// //Dispatched Report
// app.post("/generate-dispatchreport", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-allprocessoverdue/:uid/:branch_id/:user_type", authTokenMiddleware, async function (
//   req,
//   res
// ) {
...
// app.post("/set-nextprocessfinishdate", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-embassyfeesreport", authTokenMiddleware, async function (req, res) {
...
// app.get("/send-mailofprocesslimittousers", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-newCustomerofAnotherBranch/:u_id/:branch_id", authTokenMiddleware, async function (
//   req,
//   res
// ) {
...
//   });
// });
// app.post("/search-translations", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-faqcatepermission/:id", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-alldraftreceipt/:uid/:bid", authTokenMiddleware, async function (req, res) {
...
// //get all applicants
// app.get("/get-allapplicants/:m_c_id", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-TotalMonthlyInvoice", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-allpickupusers/:user_type/:branch_id", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-allinpickuplist/:id", authTokenMiddleware, async function (req, res) {
...
// app.post("/insert-pickupnote", authTokenMiddleware, async function (req, res) {
//   if (req.files != undefined) {
//     const file = req.files.file;
//     var filename = file.name;
...
// app.get("/get-alloutpickuplist/:id", authTokenMiddleware, async function (req, res) {
...
// //1403
// app.post("/pickup-done", authTokenMiddleware, async function (req, res) {
//   if (req.files != undefined) {
//     // change
...
// app.get("/get-allpickupdonelist/:id", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-allpickupdoneleadlist/:id", authTokenMiddleware, async function (req, res) {
...
// app.post("/insert-question", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-allquestion/:uid", authTokenMiddleware, async function (req, res) {
...
// app.get("/delete-question/:qid", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-question", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-dailyquestions/:u_id/:t_type", authTokenMiddleware, async function (req, res) {
...
// app.post("/insert-dailyqueans", authTokenMiddleware, async function (req, res) {
...
// app.get(
//   "/get-userschat/:u_id/:branch_id/:u_type/:is_marketing/:marketing_parent_id", authTokenMiddleware,
//   async function (req, res) {
...
// //getchat by id
// app.get(
//   "/get-chatbyid/:login_id/:s_c_id/:c_type", authTokenMiddleware,
//   async function (req, res) {
...
// app.post("/insert-usermessage", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-maincustomerchat", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-allchatcustomer/:uid/:chat_user_type", authTokenMiddleware, async function (req, res) {
...
// //Get user by id For Form Link
// app.get("/get-customeruser/:sender_id/:receiver_id", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-templatebody/:etid/:uid", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-emailhistory/:id/:type", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-draftreceiptcounter/:uid/:bid/:pmode", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-taskreport", authTokenMiddleware, async function (req, res) {
...
// });
// //get tds report
// app.post("/search-tdsreport", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-draftpayment", authTokenMiddleware, async function (req, res) {
//   const data = await adminapi.updateDraftPayment(req.body);
//   res.send({
//     ...data,
//   });
// });
// app.post("/delete-draftpayment", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-paymentmode", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-servicevalue/:country/:type/:stype", authTokenMiddleware, async function (req, res) {
...
// //insert customer
// app.post("/insert-dircustomer", authTokenMiddleware, async function (req, res) {
...
// app.post("/insert-bankdetails", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-bankdetails/:utype/:branchid", authTokenMiddleware, async function (req, res) {
...
// app.get("/delete-bankdetails/:branchid", authTokenMiddleware, async function (req, res) {
...
// app.post("/draftreceipt-read", authTokenMiddleware, async function (req, res) {
...
// app.post("/branchcustomer-read", authTokenMiddleware, async function (req, res) {
...
// app.post("/newlead-read", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-servicevaluetype/:id/:country/:stype", authTokenMiddleware, async function (req, res) {
...
// app.get("/newpickdone-read/:id", authTokenMiddleware, async function (req, res) {
...
// app.post("/leadfollow-read", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-serviceprice", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-referralcustomer/:mcid/:page/:perpage", authTokenMiddleware, async function (
//   req,
//   res
// ) {
...
// app.post("/get-maincustomerbyid", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-commisiondata", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-commsionpayment", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-commissionreportdata", authTokenMiddleware, async function (req, res) {
...
// app.post("/delete-commision", authTokenMiddleware, async function (req, res) {
...
// app.get("/check-commissiondatabyid/:id", authTokenMiddleware, async function (req, res) {
...
// //search embassyfees
// app.post("/search-embassyfees", authTokenMiddleware, async function (req, res) {
...
// //search feedback
// app.post("/search-feedback", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-paymentwithapproval", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-attestationlistbycid/:c_id/:page/:perPage", authTokenMiddleware, async function (
//   req,
//   res
// ) {
...
// //search cashinhand
// app.post("/search-cashinhand", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-embassyfeesreportall", authTokenMiddleware, async function (req, res) {
...
// //get allleadfollowup
// app.get("/get-leadfollowup/:l_id/:c_id", authTokenMiddleware, async function (req, res) {
...
// //Get user-branch Admin-staff
// app.get("/get-userlist/:bid/:uid", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-allchatnotification/:u_id", authTokenMiddleware, async function (req, res) {
...
// app.get("/user-check/:id", authTokenMiddleware, async function (req, res) {
...
// app.get("/gettodaycustomerfollowup/:id", authTokenMiddleware, async function (req, res) {
...
// app.post("/customerfollow-read", authTokenMiddleware, async function (req, res) {
...
// //counter leadfollowup
// app.post("/get-customerfollowupcounter", authTokenMiddleware, async function (req, res) {
...
// //Search main customer
// app.post("/search-attribute", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-apostillelistbycid/:c_id/:page/:perPage", authTokenMiddleware, async function (
//   req,
//   res
// ) {
...
// app.get("/get-translationbycid/:c_id/:page/:perPage", authTokenMiddleware, async function (
//   req,
//   res
// ) {
...
// app.get("/get-visabycid/:c_id/:page/:perPage", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-underprocessdate", authTokenMiddleware, async function (req, res) {
...
// app.post("/send-policymail", authTokenMiddleware, async function (req, res) {
...
// app.post("/send-codemail", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-detailid", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-allcashflow", authTokenMiddleware, async function (req, res) {
//   const data = await adminapi.getallcashflow();
//   res.send({
//     ...data,
//   });
...
// app.get("/read-cashflow/:cashflow_id", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-alldispatchingapplications/:u_id/:branch_id", authTokenMiddleware, async function (
//   req,
//   res
// ) {
...
// app.post("/update-paymentWithTdsAmount", authTokenMiddleware, async function (req, res) {
...
// app.post("/delete-paymentWithTdsAmount", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-pickupdonecourierreport", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-multiinvoicesinglecustomer", authTokenMiddleware, async function (req, res) {
...
// app.post("/search-allpickupdoneleadlist", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-cashflowdetailspdf", authTokenMiddleware, async function (req, res) {
...
// app.get("/fetch-cashflowdetails-pdf/:id", authTokenMiddleware, async function (req, res) {
//   const data = req.params;
...
// app.get("/get-commissiondetails/:c_r_id", authTokenMiddleware, async function (req, res) {
...
// app.post("/get-commissiondetailspdf", authTokenMiddleware, async function (req, res) {
...
// app.get("/fetch-commissiondetails-pdf/:id", authTokenMiddleware, async function (req, res) {
//   const data = req.params;
//   res.sendFile(`${__dirname}/public/Assets/commissionreports_pdf/commission_${data.id}.pdf`);
// });

// //Insert Leave 
// app.post("/insertleave", authTokenMiddleware, async function (req, res) {
...
// //Get Leave Data
// app.post("/getleavedata", authTokenMiddleware, async function (req, res) {
...
// //Update Leave 
// app.post("/updateleave", authTokenMiddleware, async function (req, res) {
...
// //Update Leave Status
// app.post("/updateleavestatus", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-leadcustomer/:id", authTokenMiddleware, async function (req, res) {
...
// app.get("/delete-leadcustomer/:id", authTokenMiddleware, async function (req, res) {
...
// app.post("/update-proformacustomer", authTokenMiddleware, async function (req, res) {
...
// app.get("/get-attributenamebyid/:id", authTokenMiddleware, async function (req, res) {
...
// //update Lead attestation customer
// // app.post("/update-leadattestationcustomer", async function (req, res) {
// //   const data = await adminapi.updateLeadAttestationCustomer(req.body);
// //   res.send({
// //     ...data,
// //   });
// // });
...
// // app.post("/staffmonthlyattendancereport", async function (req, res) {
// //   const data = await adminapi.StaffMonthlyAttendanceService(req.body);
// //   res.send({
// //     ...data,
// //   });
// // });

// // app.post("/getstaffcheckinoutdata", async function (req, res) {
// //   const data = await adminapi.GetStaffCheckInOutDataService(req.body);
// //   res.send({
// //     ...data,
// //   });
// // });
...
// // app.post("/updatestaffattendance", async function (req, res) {
// //   const data = await adminapi.UpdateStaffAttendanceNoteService(req.body);
// //   res.send({
// //     ...data,
// //   });
// // });
