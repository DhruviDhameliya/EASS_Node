...
const cronFinancial = require("node-cron");
...
wss.on("connection", (ws, req) => {
  ...
  console.log("urlurl", req.url.slice(1, 2));
  console.log("uid", uid);
...
var cronForFinancial = cronFinancial.schedule(`02 00 00 01 04 *`, async () => {
  console.log("cronForFinancial Cron Runnnnnnnnnnnnn");
  await adminapi.updateFinancialYear();
});

cronForFinancial.start();
...
var task8 = cron8.schedule(`30 07 * * *`, async () => {
...
var task6 = cron6.schedule(`45 08 * * *`, async () => {
