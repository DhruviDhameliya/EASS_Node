module.exports = ({ settingdata, user_data, receive, refund }) => {
    let receiveTotal = 0;
    let refundTotal = 0;
  const getrow = () => {
    let rows = "";
      ...
      receive.map((receive, index) => {
        (receiveTotal = receiveTotal + parseInt(receive.receive_amt)),
          (refundTotal =
            refundTotal +
            parseInt(
              refund[index].payment_refund ? refund[index].payment_refund : 0
            ));
        rows =
          rows +
          `<tr>
        ...
        refund.map((refund, index) => {
            (receiveTotal = receiveTotal + parseInt(  receive[index].receive_amt ? receive[index].receive_amt : 0)),
              (refundTotal =
                refundTotal +
                parseInt(
                        ...
                        <td class="p-2">
                            ...
                            ${receive[index] ? receive[index].c_prefix:""} ${
                                receive[index]? receive[index].c_name:""
                                            ...
                                            <b>(${  receive[index]? receive[index].invoice_no:""})</b>
          ...
          <table class="details_table">
              ...
              <tr>
                  <td >
                      ...
                      <span>
                      ${user_data.address != null ? user_data.address : ""}
                      ${
                  ...
                  <td >
                  <div style="text-align:right;"><img width="200px" src="https://www.truelinesolution.com/public/Asset/logo.png" alt="fed"></div>
                  </td>
