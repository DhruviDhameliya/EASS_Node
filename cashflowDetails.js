...
module.exports = ({ cashflow_data, data }) => {
  const getRows = () => {
    let rows = "";
    {
      cashflow_data
        ...
        <tr class="border heading-row">
                  ...
                  <td class="right" align="center" style="padding: 15px">
                    ${cashflow.c_prefix} ${cashflow.c_name}
                  </td>
                  <td class="right" align="center" style="padding: 15px">
                    ${cashflow.tracking_id}
                  </td>
                  <td class="right" align="center" style="padding: 15px">
    ...
    <div class="card">
        ...
        <tr class="border">
            ...
            <tr class="border">
                ...
                <b>Total : ${data.amount}</b> <br />
                <b>Payment By : ${data.u_name}</b> <br />
                </td>
                <td colspan="3" class="right" style="padding: 15px">
                <b>Payout Date : ${data.date}</b> <br />
                <b>Particulars : ${data.remark}</b><br />
                </td>
            </tr>
            <tr class="border heading-row">
                ...
                <td class="right" align="center" style="padding: 15px">Payment By</td>
